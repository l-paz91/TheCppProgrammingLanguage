...
// @ BEGIN LPTCP - add rand string creator
inline string randString(int pLength)
{
	const string characters = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz";
	...
	{
		randomString += characters[distribution(ran)];
	}

	return randomString;
}
// @ END LPTCP - add rand string creator

// @ BEGIN LPTCP - add rand double creator
...
// @ END LPTCP - add rand double creator
